...
///////////////////////////////////////////////////////////////////////////////
class YouBotBaseKinematicsTestEndurance : public CppUnit::TestFixture {
	CPPUNIT_TEST_SUITE(YouBotBaseKinematicsTestEndurance);
	CPPUNIT_TEST(youBotBaseKinematicsTest);
	CPPUNIT_TEST_SUITE_END();

public:
	YouBotBaseKinematicsTestEndurance();
	virtual ~YouBotBaseKinematicsTestEndurance();
