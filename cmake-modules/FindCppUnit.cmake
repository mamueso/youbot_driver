...
if(NOT CPPUNIT_MIN_VERSION)
   ...
   SET(PKGCONFIG_MIN_VERSION 1.8.0)
...
ELSE(CPPUNIT_INCLUDE_DIR AND CPPUNIT_LIBRARIES)
     ...
     IF(CPPUNIT_CONFIG_EXECUTABLE)
         EXEC_PROGRAM(${CPPUNIT_CONFIG_EXECUTABLE} ARGS --cflags 
RETURN_VALUE
_return_VALUE OUTPUT_VARIABLE CPPUNIT_CFLAGS)
         EXEC_PROGRAM(${CPPUNIT_CONFIG_EXECUTABLE} ARGS --libs RETURN_VALUE
_return_VALUE OUTPUT_VARIABLE CPPUNIT_LIBRARIES)
         EXEC_PROGRAM(${CPPUNIT_CONFIG_EXECUTABLE} ARGS --version 
RETURN_VALUE
_return_VALUE OUTPUT_VARIABLE PKGCONFIG_INSTALLED_VERSION)
...
${CPPUNIT_MIN_VERSION}")
         SET (PKGCONFIG_INSTALLED_VERSION ${PKGCONFIG_MIN_VERSION})
...
IF(CPPUNIT_INCLUDE_DIR AND CPPUNIT_LIBRARIES)
   ...
   IF(CPPUNIT_CONFIG_EXECUTABLE)
     EXEC_PROGRAM(${CPPUNIT_CONFIG_EXECUTABLE} ARGS --version RETURN_VALUE
_return_VALUE OUTPUT_VARIABLE PKGCONFIG_INSTALLED_VERSION)
   ENDIF(CPPUNIT_CONFIG_EXECUTABLE)

   macro_ensure_version( ${PKGCONFIG_MIN_VERSION} 
${PKGCONFIG_INSTALLED_VERSION}
PKGCONFIG_INSTALLED_VERSION_OK )

   IF(NOT PKGCONFIG_INSTALLED_VERSION_OK)
     MESSAGE ("** CppUnit version is too old: found 
${PKGCONFIG_INSTALLED_VERSION}
installed, ${CPPUNIT_MIN_VERSION} or major is required")
     SET(CppUnit_FOUND FALSE)
   ENDIF(NOT PKGCONFIG_INSTALLED_VERSION_OK)
